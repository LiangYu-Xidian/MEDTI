function [roc_avg, pr_avg, prediction] = DTINet(seed, nFold, interaction, drug_feat, prot_feat, dim_imc)
	rng(seed);
	...
	for foldID = 1 : nFold
		...
		[trainroc, trainpr] = auc(Ytrain, Zscore(train_idx), 0);%1e-6
		[testroc, testpr] = auc(Ytest, Ypred, 0);
